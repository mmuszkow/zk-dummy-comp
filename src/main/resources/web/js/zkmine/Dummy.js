 ...
 * 3. rendering mold (@see mold/zkmine.js )
 ...
 *
 */
zkmine.Dummy = zk.$extends(zul.Widget, {
	...
	*/
	bind_: function () {
		 ...
		 */
		this.$supers(zkmine.Dummy,'bind_', arguments);
	...
	*/
	unbind_: function () {
		...
		*/
		this.$supers(zkmine.Dummy,'unbind_', arguments);
	},
	/*
	...
	getZclass: function () {
		return this._zclass != null ? this._zclass: "z-dummy";
	}
});